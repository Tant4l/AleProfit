CREATE TABLE Clients (
    ...
    TaxId NVARCHAR(50) NOT NULL UNIQUE, -- NIP (Strictly unique per tenant)
...
CREATE TABLE AllegroFeeCategories (
    ...
    CategoryGroup NVARCHAR(50) NOT NULL, -- 'COMMISSION', 'LOGISTICS', 'MARKETING', 'ADJUSTMENT', 'UNCATEGORIZED'
...
('PAD', 'ADJUSTMENT', 0); -- PAD is automatic deduction (Cashflow only, not P&L cost)
